...
class ImportExportService {
    ...
    /**
     * Generate a URL-safe slug from a name. Delegates to RoomService so
     * import-matching uses the exact same slug (incl. umlaut transliteration).
     */
    private function generateSlug(string $name): string {
        return RoomService::generateSlug($name);
    }
}
