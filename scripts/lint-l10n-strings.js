 ...
 * locked the RoomVox resource in #63 over exactly these categories, so catching
 ...
 * (RoomVox, MetaVox, API, URL, ZIP, OAuth2, …), so that stays a human review
...
const PROPER = /\b(RoomVox|MetaVox|SearchVox|FormVox|CalVox|VoxCloud|Nextcloud|Photo Story|File Story|API|URL|URLs|ZIP|OAuth2?|RSS|PDF|ID|IDs|HTML|CSS|JSON|CSV|SSO|OIDC|SAML|iCal|CalDAV|WebDAV|GroupFolder|FormVox|OnlyOffice|Collabora)\b/g;
