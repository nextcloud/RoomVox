 ...
 *
 * Why: RoomVox translations round-trip through the Nextcloud Transifex bot. New
 * source strings only become translatable once `npm run l10n:push` regenerates
 * translationfiles/templates/roomvox.pot + this manifest and they are committed
